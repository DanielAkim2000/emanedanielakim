...
const Home = () => {
  ...
  React.useEffect(() => {
    ...
    return () => {
      if (competenceRef.current) observer.unobserve(competenceRef.current);
    ...
    <div className="w-full bg-akim">
      <DivMaxWidth>
        <div className="flex justify-start gap-[30rem] w-full h-screen max-md:text-center max-lg:justify-center">
          <div className="sticky flex flex-col self-center gap-3 pb-20 text-left max-lg:text-center top-10">
            <h1 className="mt-10 text-4xl font-semibold text-yellow-500 max-md:text-2xl animate__animated animate__fadeInUp animate-delay-fast">
              Bonjour, je suis
            </h1>
          ...
          <div className="sticky self-end h-auto pb-1 max-lg:hidden top-20">
            <img
              src={Myimg}
              alt="myimg"
          ...
          <div className="mb-10" ref={competenceRef} id="competence">
            ...
            <h2
              className={`text-4xl text-white font-serif font-semibold animate__animated ${
                isVisible.competence && "animate__fadeInUp animate-delay-medium"
              }`}
            >
              Services
            </h2>
      ...
      <div className="w-full">
        <DivMaxWidth className="text-left py-28">
          <div className="mb-10" ref={projetsRef} id="projets">
            ...
            <h2
              className={`text-4xl text-white font-serif font-semibold animate__animated ${
                isVisible.projets && "animate__fadeInUp animate-delay-medium"
              }`}
            >
              Projets
            </h2>
          ...
          >
            <Carrousel>
              {projets
                ? projets.map((projet) => (
                    <CardProjet key={projet.title} projet={projet} />
                  ))
                : null}
            </Carrousel>
          </div>
